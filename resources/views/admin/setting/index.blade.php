                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <!-- text input -->
                                    <div class="form-group row no-gutters">
                                        <label for="app_email" class="col-sm-3 col-form-label">App Email</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="app_email" class="form-control" id="app_email"
                                                   value="{{settings('app_email')}}" placeholder="App email">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- text input -->
                                    <div class="form-group row no-gutters">
                                        <label for="app_mobile" class="col-sm-3 col-form-label">App Mobile</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="app_mobile" class="form-control" id="app_mobile"
                                                   value="{{settings('app_mobile')}}" placeholder="App mobile">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row no-gutters">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="app_address" class="form-control" id="app_address"
                                                   value="{{settings('app_address')}}" placeholder="App address">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row no-gutters">
                                        <label for="about_short_info" class="col-sm-3 col-form-label">About Short Info</label>
                                        <div class="col-sm-9">
                                            <textarea name="about_short_info" placeholder="About short info" class="form-control">{{settings('about_short_info')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group row no-gutters">
                                        <label for="about_long_info" class="col-sm-3 col-form-label">About Long Info</label>
                                        <div class="col-sm-9">
                                            <textarea name="about_long_info" placeholder="About long info" class="form-control" rows="5">{{settings('about_long_info')}}</textarea>
