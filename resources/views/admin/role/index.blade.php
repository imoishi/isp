            ...
            <div class="modal-dialog modal-xl ">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row no-gutters">
                            <label for="createExpensePermission" class="col-sm-2 col-form-label">Expense Permission</label>
                            <div class="col-sm-10" id="createExpensePermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="createPackagePermission" class="col-sm-2 col-form-label">Package Permission</label>
                            <div class="col-sm-10" id="createPackagePermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="createCustomerPermission" class="col-sm-2 col-form-label">Customer Permission</label>
                            <div class="col-sm-10" id="createCustomerPermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="createBillPermission" class="col-sm-2 col-form-label">Bill Permission</label>
                            <div class="col-sm-10" id="createBillPermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="createOtherPermission" class="col-sm-2 col-form-label">Others Permission</label>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row no-gutters">
                            <label for="editExpensePermission" class="col-sm-2 col-form-label">Expense Permission</label>
                            <div class="col-sm-10" id="editExpensePermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="editCustomerPermission" class="col-sm-2 col-form-label">Customer Permission</label>
                            <div class="col-sm-10" id="editCustomerPermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="editPackagePermission" class="col-sm-2 col-form-label">Package Permission</label>
                            <div class="col-sm-10" id="editPackagePermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
                            <label for="editBillPermission" class="col-sm-2 col-form-label">Bill Permission</label>
                            <div class="col-sm-10" id="editBillPermission">
                            </div>
                        </div>
                        <div class="form-group row no-gutters">
...
@push('script')
    <script>
        ...
        function openCreateRoleModal() {
            ...
            $('#createExpensePermission').html('');
            $('#createPackagePermission').html('');
            $('#createCustomerPermission').html('');
            $('#createBillPermission').html('');
            ...
            $.each(permissions, function (index, permission) {
                ...
                if (permission.for === 'expense') {
                    $('#createExpensePermission').append(
                        "<div class='icheck-success d-inline mr-2'>" +
                        "<input type='checkbox' name='permission_id[]' value='" + permission.id + "' id='" + 'create' + permission.id + "'>" +
                        "<label for='" + 'create' + permission.id + "'>" + permission.name + "</label></div>");
                }

                if (permission.for === 'package') {
                    $('#createPackagePermission').append(
                        "<div class='icheck-success d-inline mr-2'>" +
                        "<input type='checkbox' name='permission_id[]' value='" + permission.id + "' id='" + 'create' + permission.id + "'>" +
                        "<label for='" + 'create' + permission.id + "'>" + permission.name + "</label></div>");
                }
                ...
                if (permission.for === 'customer') {
                    $('#createCustomerPermission').append(
                        "<div class='icheck-success d-inline mr-2'>" +
                        "<input type='checkbox' name='permission_id[]' value='" + permission.id + "' id='" + 'create' + permission.id + "'>" +
                        "<label for='" + 'create' + permission.id + "'>" + permission.name + "</label></div>");
                }

                if (permission.for === 'bill') {
                    $('#createBillPermission').append(
                        "<div class='icheck-success d-inline mr-2'>" +
                        "<input type='checkbox' name='permission_id[]' value='" + permission.id + "' id='" + 'create' + permission.id + "'>" +
                        "<label for='" + 'create' + permission.id + "'>" + permission.name + "</label></div>");
                }
        ...
        function openEditRoleModal(id) {
            ...
            $('#roleEditForm').attr('action', app_url + '/roles/' + role.id);
            ...
            $('#editExpensePermission').html('');
            $('#editPackagePermission').html('');
            $('#editBillPermission').html('');
            $('#editCustomerPermission').html('');
